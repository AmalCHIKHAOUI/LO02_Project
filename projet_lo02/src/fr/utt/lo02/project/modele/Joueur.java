    ...
    public Partie jouer(Partie partie, int nbJoueurTot) {
		...
		if(action == 1) {
	    	...
	    	while(check == false) {
	    		...
	    		/*if(numJoueurAcc > 0 && numJoueurAcc <= nbJoueurTot && numJoueurAcc != this.numJoueur && partie.joueur.get(numJoueurAcc-1).revealed == false) {
	    			check = true;
	    		}
	    		else {
	    			System.out.println("---------------------------------");
	            	System.out.println("La saisie est incorrecte 17");
	            	System.out.println("---------------------------------");
	    		}*/
	    		if(numJoueurAcc <= 0 || numJoueurAcc>nbJoueurTot) {
	    			System.out.println("---------------------------------");
	            	System.out.println("Le numero saisie est en dehors des limites autorisees");
	    		}
	    		else if (numJoueurAcc == this.numJoueur) {
	    			System.out.println("---------------------------------");
	            	System.out.println("Le numero saisie est votre numero de joueur");
	    		}
	    		else if (partie.joueur.get(numJoueurAcc-1).revealed) {
	    			System.out.println("---------------------------------");
	            	System.out.println("le joueur choisi est deja revele");
	    		}
	    		else {
	    			check = true;
	    		}
