...
public class Partie extends Observable {
    ...
    public void finRound() {
		...
		// ------- RÈcap des points de chaque joueur ----------
		System.out.println("RÈcapitulatif des points de chaque joueur : ");
    ...
    public void effetHunt(CarteRumeur carte, int numJoueur) {
    	...
    	if(carte.hunt == Hunt.ANGRYMOB){ // reveler la carte d'un autre joueur
    		...
    		if(action==1) {
        		...
        		System.out.println("Carte supprimee !!!") ;
        		System.out.println("----------------------------------") ;
        		System.out.println("Joueur "+numJ+", vous prenez le prochain tour et voici votre jeu actualisÈ : ") ;
        		System.out.println(j1.main);
